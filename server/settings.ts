...
export const SETTINGS_REGISTRY: SettingDef[] = [
  // Azienda
  { key: 'company_name', category: 'azienda', envVar: 'COMPANY_NAME', description: 'Nome azienda (usato nei prompt degli agenti)', sensitive: false, defaultValue: 'FIAI', requiresRestart: false },
  { key: 'company_short_name', category: 'azienda', envVar: 'COMPANY_SHORT_NAME', description: 'Nome breve azienda', sensitive: false, defaultValue: 'FIAI', requiresRestart: false },

  // Planning
  { key: 'planning_api_url', category: 'planning', envVar: 'PLANNING_API_URL', description: 'URL API planner trasporti (via VPN)', sensitive: false, defaultValue: 'http://192.168.0.14:8602', requiresRestart: false },
